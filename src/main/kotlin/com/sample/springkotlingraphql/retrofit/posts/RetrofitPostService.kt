...
@Component
class RetrofitPostService {

    companion object {
        const val BASE_URL = "https://jsonplaceholder.typicode.com"
    }

    val retrofit: PostAPI = retrofit()
    ...
    private fun retrofitPostAPIBuilder(retrofit: Retrofit.Builder): PostAPI {
        return retrofit
                .build()
                .create(PostAPI::class.java)
    }

    private fun retrofit(): PostAPI {
