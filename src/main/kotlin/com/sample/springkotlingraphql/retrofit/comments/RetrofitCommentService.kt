...
@Component
class RetrofitCommentService {

    companion object {
        const val BASE_URL = "https://jsonplaceholder.typicode.com"
    }

    val retrofit: CommentAPI = retrofit()
    ...
    private fun retrofitPostAPIBuilder(retrofit: Retrofit.Builder): CommentAPI {
        return retrofit
                .build()
                .create(CommentAPI::class.java)
    }

    private fun retrofit(): CommentAPI {
